...
import stinger.commands
from stinger.commands.config import CowrieConfig
from stinger.commands import command, honeypot
...
class HoneyPotBaseProtocol(insults.TerminalProtocol, TimeoutMixin):
    ...
    commands = {}
    for c in stinger.commands.__commands__:
        try:
            module = __import__(
